...
router.get("/products", async (req, res) => {
    try {
        ...
        res.json({
            ...
            hasPrevPage: products.hasPrevPage, // Check if there is a previous page
            hasNextPage: products.hasNextPage, // Check if there is a next page
            prevPage: products.hasPrevPage ? parseInt(page) - 1 : null, // Provide the previous page number if it exists
            nextPage: products.hasNextPage ? parseInt(page) + 1 : null // Provide the next page number if it exists
        });
    } catch (error) {
